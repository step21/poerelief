...
#This gets a record from supplied id + loc
  ...
  def pEvalRecord(self, record):
    ...
    try:
      record.TEI
    #make other tries also hierachic?
    except IndexError:
      print "IndexError, no TEI present"
    else:
      try:
        record.TEI.teiHeader
      except IndexError:
        print "IndexError, no teiHeader"
      else:
        try:
        ...
        try:
          ...
          try:
            record.TEI.teiHeader.fileDesc.sourceDesc.msDesc.physDesc.objectDesc.supportDesc.condition.p
          except IndexError:
            self.condition = None
            print "IndexError because of probably empty condition tag"
          else:
        ...
        try:
          ...
          print "IndexError was raised for person"
        else:
          if type(record.TEI.teiHeader.profileDesc.particDesc.listPerson.person) is ListType:
            ...
            for d in record.TEI.teiHeader.profileDesc.particDesc.listPerson.person:
              try:
                ...
                print "Error was raised during events"
              else:
        ...
        try:
          ...
          try:
            record.TEI.text.body.div[4].p
          except IndexError:
            print "IndexError, no p in proso"
            self.proso = None
          else:
